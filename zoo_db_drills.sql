...
******************************************************/
	...
	CREATE TABLE tbl_sports (
		...
		sports_grade INT NOT NULL CONSTRAINT fk_students_grade FOREIGN KEY REFERENCES tbl_student (students_grade) ON UPDATE CASCADE ON DELETE CASCADE,
...
SELECT * FROM tbl_students;
  ...
  INSERT INTO tbl_sport
  (sport_grade, sport_location)
  VALUES
  (1,'school gym' ),
  (2,'Fitzgerald field' ),
  (3,'out field' ),
